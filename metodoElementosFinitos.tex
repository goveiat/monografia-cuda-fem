...
Na subseção a seguir, um modelo de elementos discretos representando uma associação de resistores será apresentado e resolvido.
...
A seguir cada etapa é vista em detalhes e exemplificada com um sistema de elementos discretos.
